...
public class ObjectFactory {
    ...
    private final static QName _Rear_QNAME = new QName("", "rear");
     ...
     * 
     */
    @XmlElementDecl(namespace = "", name = "rear")
    public JAXBElement<String> createRear(String value) {
        return new JAXBElement<String>(_Rear_QNAME, String.class, null, value);
    }
